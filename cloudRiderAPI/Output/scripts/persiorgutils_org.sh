...
ORDERER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/persi.com/orderers/persiorderer.persi.com/msp/tlscacerts/tlsca.persi.com-cert.pem

PEER0_persiorg1_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/persiorg1.persi.com/peers/peer0.persiorg1.persi.com/tls/ca.crt
...
setOrdererGlobals() {
  ...
  CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/persi.com/orderers/persiorderer.persi.com/msp/tlscacerts/tlsca.persi.com-cert.pem
  CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/persi.com/users/Admin@persi.com/msp
}
...
setGlobals() {
  ...
  ORG=$2
    ...
    CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_persiorg1_CA
    ...
    CORE_PEER_ADDRESS=peer$PEER.persiorg$ORG.persi.com:8501
...
fetchChannelConfig() {
  ...
  if [ -z "$CORE_PEER_TLS_ENABLED" -o "$CORE_PEER_TLS_ENABLED" = "false" ]; then
    set -x
    peer channel fetch config config_block.pb -o persiorderer.persi.com:7050 -c $CHANNEL --cafile $ORDERER_CA
    set +x
  else
    set -x
    peer channel fetch config config_block.pb -o persiorderer.persi.com:7050 -c $CHANNEL --tls --cafile $ORDERER_CA
    set +x
  fi
