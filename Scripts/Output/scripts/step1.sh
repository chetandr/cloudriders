...
createConfigUpdate ${CHANNEL_NAME} config.json modified_config.json PARAM_SHORT_ORG_update_in_envelope.pb

echo
echo "========= Config transaction to add PARAM_SHORT_ORG to network created ===== "
echo

echo "Signing config transaction"
echo
signConfigtxAsPeerOrg 1 PARAM_SHORT_ORG_update_in_envelope.pb
...
echo
echo "========= Config transaction to add PARAM_SHORT_ORG to network submitted! =========== "
echo
